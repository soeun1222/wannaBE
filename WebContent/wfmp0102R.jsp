...
<body>
	...
	<div class="re_center">   		
		<table class="re_padding">
			<form name="edit_frm" method="post" action="idEdit_Ok.jsp?u_id=<%= u_id %>">
				<tr>
					<td colspan="2">
				...
				<tr>
					<td>이    름*</td>
					<td>
						<input name="u_name" size="30" value="<%= u_name %>">
					</td>
				</tr>
				<tr>
					<td>이메일*</td>
					<td>
						<input name="u_email" size="30" value="<%= u_email %>">
					</td>
				</tr>
				<tr>
					<td>휴대전화*</td>
					<td>
						<input name="u_phone" size="30" value="<%= u_phone %>">
					</td>
				</tr>
				<tr>
					<td>생년월일*</td>
				...
				<tr>
					<td colspan="2" align="center">
						<input type="button" value="수정하기" class="re_submit" onclick="idedit_ok()">
						&nbsp;&nbsp;&nbsp;
